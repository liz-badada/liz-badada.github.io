...
![Device API 三模式与底层互联](../../assets/papers/nccl-gin/NCCL_device_API.png)
...
![Device API（左）vs 传统 host-initiated NCCL（右）](../../assets/papers/nccl-gin/gin_high_level.png)

---

## 3. GIN 三层架构

![NCCL GIN 三层架构：NCCL Core → Device GIN API → GinNet Plugin（GDAKI / Proxy 双后端）；右侧灰色路径为原有 two-sided collectives](../../assets/papers/nccl-gin/GIN_arch.png)
